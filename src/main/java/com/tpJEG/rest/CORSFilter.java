...
public class CORSFilter implements ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext request, ContainerResponseContext response) throws IOException {
        ...
        request.getHeaders().add("Access-Control-Allow-Headers", "origin, content-type, accept, authorization, Etag, if-none-match");
        ...
        request.getHeaders().add("Access-Control-Max-Age", "1209600");
        request.getHeaders().add("Access-Control-Expose-Headers", "origin, content-type, accept, authorization, ETag, if-none-match");
